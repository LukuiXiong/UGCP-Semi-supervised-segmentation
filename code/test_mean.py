...
if __name__ == '__main__':
    ...
    parser.add_argument('--lora_ckpt', type=str, default='output/sam/results_ssl/D3_no_loss3_ACDC/ACDC_512_pretrain_vit_b_dualmask_same_prompt_class_random_large_epo10000_bs12_lr0.0013_s1337_1_labeled_warm200_D3_ACDC_0.35_0.1_0.15_0.7*0.3_T0.1/iter_29000_dice_0.8488.pth', help='The checkpoint from LoRA')
    parser.add_argument('--exp', type=str, default='warm200_D3_ACDC_1_label_0.7*0.3')
