...
from trainer_dualmask_acdc import trainer_acdc_dualmask_prompt_ssl_fixcoe_random_new_mean_up
...
parser.add_argument('--output', type=str, default='output/sam/results_ssl/D3_no_loss3_ACDC')
...
parser.add_argument('--base_lr', type=float, default=0.0013,
...
parser.add_argument('--warm_iter', type=int, default=200,help='labeled data') 
parser.add_argument('--method', type=str, default='warm200_D3_ACDC_0.35_0.1_0.15_0.7*0.3')
...
parser.add_argument('--coe', type=float,
                    default=0.35, help='coe')
parser.add_argument('--coe2', type=float,
                    default=0.1, help='coe')
parser.add_argument('--coe3', type=float,
                    default=0.15, help='coe')
