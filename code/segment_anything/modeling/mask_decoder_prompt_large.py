...
class MaskDecoder_prompt_large(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.dim_mlp =128
        self.projecter = nn.Sequential(nn.AvgPool2d(2, 2), nn.Conv2d(32, self.dim_mlp, kernel_size=1, bias=False), nn.ReLU(), nn.Conv2d(self.dim_mlp,self.dim_mlp, kernel_size=1, bias=False))
    ...
    def forward(
        ...
        embed = dense_features #None #self.projecter(dense_features)

        return masks, iou_pred, embed
